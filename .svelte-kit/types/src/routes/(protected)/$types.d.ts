...
type LayoutRouteId = RouteId | "/(protected)/cookbooks" | "/(protected)/cookbooks/new" | "/(protected)/cookbooks/[id]" | "/(protected)/recipes/new" | "/(protected)/recipes/[id]" | "/(protected)/shared-with-me"
